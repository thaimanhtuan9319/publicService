...
if(isset($_POST['submitted'])){
    ...
    // Kiem tra tai khoan nguoi dung nhap vao co phai tai khoan
    // can bo hay khong
    $sql2 = "select * from users where Username = '$name' and Password = '$pass' and User_type = '2';";
    $result2 = mysqli_query($con, $sql2);
    $numrows2 = mysqli_num_rows($result2);
    
    // Kiem tra tai khoan nguoi dung nhap vao co phai tai khoan 
    // thuong hay khong
    $sql3 = "select * from users where Username = '$name' and Password = '$pass' and User_type = '3';";
