...
<div id="content"  style="width: 750px">
    <div style="margin-left: 150px">
        <h2 style="font-weight: bold;font-size: 19pt;margin-top: 15px;overflow: hidden;">Xóa tài khoản công dân</h2>
        <div style="height: 30px"></div>
        <form method="POST" action="" accept-charset='UTF-8'>
            <fieldset class="fieldset">
                <h3 class="create-account-label">Lựa chọn tài khoản công dân cần xóa</h3>
