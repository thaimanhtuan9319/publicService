...
<div id="container">
    ...
    <form method="POST" action="" accept-charset='UTF-8'>
        <fieldset style="text-align: center;">
            ...
            <input class="create-account-input" type="text" name="firstname" value="<?php echo
$firstname; ?>" />
            ...
            <input class="create-account-input" type="text" name="lastname" value="<?php echo
$lastname; ?>"/>
            ...
            <input class="create-account-input" type="text" name="username" value="<?php echo
$username; ?>"/>
            ...
            <input class="create-account-input" type="text" name="email" value="<?php echo
$email; ?>"/>
